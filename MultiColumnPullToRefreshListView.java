...
package com.sprite.mimi.widget.waterfall;
...
public class MultiColumnPullToRefreshListView extends MultiColumnListView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        pullToRefreshText = getContext().getString(R.string.xlistview_header_hint_normal);
        releaseToRefreshText = getContext().getString(R.string.xlistview_header_hint_ready);
        refreshingText = getContext().getString(R.string.xlistview_header_hint_loading);
        lastUpdatedText = getContext().getString(R.string.xlistview_header_last_time);
